...
export default function TarjetaViaje({ viaje }) {
    ...
    useEffect(() => {
        ...
        fetch("http://tripwme.work.gd:8080/api/me", {
        ...
        fetch("http://tripwme.work.gd:8080/api/mis-viajes", {
            headers: {
        ...
        fetch(`http://tripwme.work.gd:8080/api/viajes/${viaje.id}/participantes`, {
            headers: {
                Authorization: `Bearer ${token}`,
            },
        })
    ...
    const unirse = async () => {
        ...
        const res = await fetch(`http://tripwme.work.gd:8080/api/unirse/${viaje.id}`, {
            method: "POST",
            headers: {
    ...
    const cancelar = async () => {
        ...
        const token = localStorage.getItem("token");
        const res = await fetch(`http://tripwme.work.gd:8080/api/cancelar-plaza/${usuarioViaje.id}`, {
        method: "DELETE",
        headers: {
            Authorization: `Bearer ${token}`,
        },
    ...
    const handleCancelarViaje = async () => {
        ...
        const token = localStorage.getItem("token");
        const res = await fetch(`http://tripwme.work.gd:8080/api/cancelar-viaje/${viaje.id}`, {
            method: "DELETE",
            headers: {
                Authorization: `Bearer ${token}`,
            },
