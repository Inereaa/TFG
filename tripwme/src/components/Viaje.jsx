...
export default function TarjetaViaje({ viaje }) {
    ...
    useEffect(() => {
        ...
        fetch("https://tripwme.work.gd:8443/api/me", {
        ...
        fetch("https://tripwme.work.gd:8443/api/mis-viajes", {
            headers: {
        ...
        fetch(`https://tripwme.work.gd:8443/api/viajes/${viaje.id}/participantes`, {
            headers: {
                Authorization: `Bearer ${token}`,
            },
        })
    ...
    const unirse = async () => {
        ...
        const res = await fetch(`https://tripwme.work.gd:8443/api/unirse/${viaje.id}`, {
            method: "POST",
            headers: {
    ...
    const cancelar = async () => {
        ...
        const token = localStorage.getItem("token");
        const res = await fetch(`https://tripwme.work.gd:8443/api/cancelar-plaza/${usuarioViaje.id}`, {
        method: "DELETE",
        headers: {
            Authorization: `Bearer ${token}`,
        },
    ...
    const handleCancelarViaje = async () => {
        ...
        const token = localStorage.getItem("token");
        const res = await fetch(`https://tripwme.work.gd:8443/api/cancelar-viaje/${viaje.id}`, {
            method: "DELETE",
            headers: {
                Authorization: `Bearer ${token}`,
            },
