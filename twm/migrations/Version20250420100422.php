 ...
 */
final class Version20250420100422 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE usuario_viaje (id INT AUTO_INCREMENT NOT NULL, usuario_id INT DEFAULT NULL, viaje_id INT DEFAULT NULL, revendido TINYINT(1) NOT NULL, precio_reventa DOUBLE PRECISION NOT NULL, INDEX IDX_9F8708DB38439E (usuario_id), INDEX IDX_9F870894E1E648 (viaje_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
